...
public class UserService {
    ...
    public UserModel findById(Long id) throws Exception {
        var user = userRepository.findById(id)
                .orElseThrow(() -> new Exception(" User id: " + id));
    ...
    public UserModel patchUser(Long id, Map<String, Object> patchObjects) throws Exception {
        var user = findById(id);
        patchObjects.forEach((key, value) -> {
            switch (key) {
                case "name" -> user.setName(String.valueOf(value));
                case "address" -> user.setAddress(String.valueOf(value));
                case "country" -> user.setCountry(String.valueOf(value));
                default -> log.error("");
            }
        });
    ...
    public UserModel saveOrUpdateUser(Long id, UserModel userModel) throws Exception {
        findById(id);
